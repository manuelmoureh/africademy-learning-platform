...
export default function App() {
  ...
  const LESSON_PAGE_TRACKS = new Set(['whatsapp-retail-agent', 'lead-capture-bot', 'invoicing-assistant', 'support-ticketing-agent', 'booking-scheduler-agent', 'social-content-agent']);
