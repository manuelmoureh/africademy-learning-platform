...
export const PLACEHOLDER_VERIFIED_WORK: PortfolioVerification[] = [
  {
    ...
    smeReviewer: {
      ...
      location: 'Nairobi',
      quote: "This is the system running our own store today, product discovery, WhatsApp ordering, M-Pesa and card checkout, delivery, all of it. It's reduced buying friction and cut the manual work out of running the shop.",
      avatarInitials: 'MM',
    },
    metrics: [
